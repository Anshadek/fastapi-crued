...
@app.post("/emp", response_model=schemas.ToDo, status_code=status.HTTP_201_CREATED)
...
@app.get("/emp/{id}", response_model=schemas.ToDo)
...
@app.put("/emp/{id}", response_model=schemas.ToDo)
...
@app.get("/emp", response_model = List[schemas.ToDo])
